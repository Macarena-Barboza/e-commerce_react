      ...
      <div className='carrito'>
          <h3>Carrito:</h3>
        {
          ...
          (<div className='carrito__text'>
            ...
            <Link to='/' className='carrito__btn__link'> <button className='carrito__btn'>Ir a la Tienda</button></Link>
          </div>
          )
          :
          (
          ...
          <div className='carrito__total'>
            <Link to='/' className='carrito__btn__link'> <button className='carrito__btn'>Seguir Comprando</button></Link>
