        ...
        <div className="producto">
            ...
            <div className="producto__text">
                ...
                <div className="producto__text__cont">
                    <p className="producto__text__precio">
                        {FormatPrice(data.precio)}
                    </p>
                    <button className="producto__text__ico" onClick={onAddFav}>
                        <FaHeart />
                    </button>
                </div>

                {data.stock === 0 && (
                    <span style={{ color: "#ff0000" }}>Producto sin Stock</span>
                )}
